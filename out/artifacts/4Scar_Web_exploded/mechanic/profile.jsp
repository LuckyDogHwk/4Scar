...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .zoom-controls { position: fixed; bottom: 20px; right: 20px; background: white; border-radius: 30px; padding: 8px 15px; box-shadow: 0 4px 15px rgba(0,0,0,0.2); display: flex; align-items: center; gap: 10px; z-index: 1000; }
        .zoom-controls button { width: 32px; height: 32px; border: none; border-radius: 50%; background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; font-size: 16px; cursor: pointer; transition: all 0.3s; display: flex; align-items: center; justify-content: center; }
...
<body>
    ...
    <div class="container">
        ...
        <div class="card">
            <div class="avatar-section">
                ...
                <span class="role-badge role-mechanic">维修人员</span>
            </div>
    ...
    <script>
        let currentZoom = 100;
        const zoomStep = 10;
        function updateZoom() { document.body.style.zoom = currentZoom + '%'; document.getElementById('zoom-level').textContent = currentZoom + '%'; }
        function zoomIn() { if (currentZoom < 200) { currentZoom += zoomStep; updateZoom(); } }
        function zoomOut() { if (currentZoom > 50) { currentZoom -= zoomStep; updateZoom(); } }
